...
datasetA = dict(
    type='FewshotLogDet',
    ann_file=
    '/farm/caixinhao/fewshotlogodetection_round2_train/train/annotations/train_stage2.json',
    img_prefix=
    '/farm/caixinhao/fewshotlogodetection_round2_train/train/images/',
    pipeline=[
        dict(type='LoadImageFromFile'),
        dict(type='LoadAnnotations', with_bbox=True),
        dict(
...
data = dict(
    ...
    val=dict(
        type='FewshotLogDet',
        ann_file=
        '/farm/caixinhao/fewshotlogodetection_round2_train/train/annotations/instances_train2017.json',
        img_prefix=
        '/farm/caixinhao/fewshotlogodetection_round2_train/train/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
    ...
    test=dict(
        type='FewshotLogDet',
        ann_file=
        '/farm/caixinhao/fewshotlogodetection_round2_test/val/annotations/instances_val2017.json',
        img_prefix=
        '/farm/caixinhao/fewshotlogodetection_round2_test/val/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
log_level = 'INFO'
load_from = "/farm/caixinhao/CBNetV2/work_dirs/bisai/swin_base/cascade_mask_rcnn/swa_weights.pth"
resume_from = None
workflow = [('train', 1)]
fp16 = None
work_dir = './work_dirs/bisai/swin_base/cascade_mask_rcnn_stage2'
gpu_ids = range(0, 4)
